...
So you want to work in DevRel — or you are building a team, or you are trying to understand why two people with the same job title do completely different things and both seem to be right.

The answer is that DevRel practitioners carry different instruments.

Not different skills in the sense of a skills matrix. Different fundamental capabilities — the kind that are not easily trained into someone who does not already have the seed of them. Understanding which instrument a practitioner carries is more useful than any job description, because it tells you what they will naturally be good at, where they will struggle, what they need to develop, and which programmes they should own.
...
These are not exclusive categories. Most DevRel practitioners carry more than one instrument, with a dominant tendency. Someone might be a strong EE with enough CC to build the relationships needed to know what to teach next. Another might be an RR whose resonance is grounded in genuine EE depth.
...
These instruments do not map to personality types. An EE can be an extrovert who owns a stage or an introvert who writes the definitive reference that everyone cites. A CC can work a room or build deep one-on-one relationships over years. An RR can hold an audience of thousands or write the article that changes how a field thinks about a problem.

...
| --- | --- |
| **People** | Led by CC practitioners (relationship fabric); EE practitioners contribute content; RR practitioners contribute credibility and keynote presence; partnered with Marketing (logistics, production) and Engineering (contributor events) |
| **Process** | Community sensing (what does the ecosystem need?) → format design → speaker and participant outreach → logistics and production → follow-up and relationship capture → signal routing back to Intel |
...
| Dimension | Description |
| --- | --- |
| **People** | Led by CC practitioners (contributor relationships) and EE practitioners (contributor documentation and onboarding); partnered with Engineering (contribution review and acceptance) and Product (contribution roadmap alignment) |
| **Process** | Contributor pathway design → first-contribution onboarding → recognition and reward → escalation to committer/maintainer status → ongoing relationship maintenance |
...
| **Customer Success** | Guardian identification within the customer base; warm introductions for the CC to potential Guardians |
| **Product** | Early access and roadmap sessions for Guardians; contribution pathway alignment with product direction |

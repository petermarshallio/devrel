...
| --- | --- |
| **People** | Led by EE practitioners; partnered with Product (for accuracy), Customer Success (for learner feedback), and Engineering (for deep technical review) |
| **Process** | Curriculum design → content production → review and validation → publication → measurement of completion and downstream behaviour change |
...
| Dimension | Description |
| --- | --- |
| **People** | Co-owned by EE practitioners and dedicated technical writers; partnered with Engineering (source of truth), Product (feature coverage), and Customer Success (most common friction points) |
| **Process** | Content strategy → authoring → technical review → publication → feedback loop (search queries, support ticket analysis, community questions) → update |
...
| Dimension | Description |
| --- | --- |
| **People** | Led by EE practitioners; may involve Solutions Engineering or Customer Success for commercial relationship contexts; community Guardians increasingly take on peer tutoring as the ecosystem matures |
| **Process** | Scheduling and booking → session delivery → post-session follow-up documentation (answers that belong in docs) → signal routing to EE content team |
...
| **Customer Success** | Frontline signal about where practitioners stall; identifying which friction is educational versus product |
| **Marketing** | Distribution of educational content; SEO; ensuring discoverability |
